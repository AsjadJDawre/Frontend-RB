  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-gradient-to-br from-green-400 to-blue-500">
      <div className="flex flex-col items-center space-y-6">
        ...
        {/* Success Message */}
        <h1 className="text-4xl font-bold text-white">Your Booking is Successfull!</h1>
        <p className="text-lg text-white text-center">
        Your booking was successful but is currently pending due to admin restrictions. Your booking will be delivered only after admin approval. Please wait for approval.
